package _8SpringData._1SpringData._7SpringDataAutoMappingObjects._1Lab._2AdvancedMapping.org.softwareuniversityspringdata;
...
import _8SpringData._1SpringData._7SpringDataAutoMappingObjects._1Lab._2AdvancedMapping.org.softwareuniversityspringdata.service.EmployeeService;
import _8SpringData._1SpringData._7SpringDataAutoMappingObjects._1Lab._2AdvancedMapping.org.softwareuniversityspringdata.service.dtos.ManagerDTO;
...
public class CommandLineRunnerImpl implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Employee manager1 = createNewEmployee("Steve", "Jobbsen", 6000.00, LocalDate.of(2000, 1, 1), address1);
        Employee manager2 = createNewEmployee("Carl", "Kormac", 6000.00, LocalDate.of(2000, 1, 1), address2);

        Employee employee1 = createNewEmployee("Stephen", "Bjorn", 4300.00, LocalDate.of(2000, 2, 1), address3);
        Employee employee2 = createNewEmployee("Kirilyc", "Lefi", 4400.00, LocalDate.of(2000, 2, 2), address4);
        ...
        ManagerDTO managerDTO1 = modelMapper.map(manager1, ManagerDTO.class);
        ManagerDTO managerDTO2 = modelMapper.map(manager2, ManagerDTO.class);

        System.out.printf("%s%n", managerDTO1);
        System.out.printf("%s%n", managerDTO2);
    }
